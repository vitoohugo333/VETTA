...
- Não há código do aplicativo, build ou publicação configurados nesta etapa.
...
Definir e aprovar o primeiro recorte de produto antes de criar ou alterar código.
